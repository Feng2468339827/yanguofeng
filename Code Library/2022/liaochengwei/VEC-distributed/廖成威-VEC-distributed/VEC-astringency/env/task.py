...
class Task:
    ...
    def task_generate(self, ):
        ...
        subtask_size = round(random.uniform(2, 8), 1)  # 子任务数据大小 2-8M
        subtask_cycle = subtask_size * 1e6 * cycle * 1e-9  # 子任务所需的cpu周期数1-4GHz
        subtask_max_time = random.choice([0.5, 1, 2, 4])  # 子任务最大可容忍时延
