...
#                 actions = []
#                 for _ in range(3):
#                     decide = random.randint(0, 11)  # 选择动作 state1 state2
#                     decides.append(decide)
#                 state3 = env.get_state3(decides)
#                 # if T > 1:
#                 #     replay_buffer.add(state, action, reward, next_state, done)
#                 #     pre_state3 = state3
#
#                 total = 1.0
#                 random_number1 = random.triangular(0, total, 0)
#                 random_number2 = random.triangular(0, total - random_number1, 0)
#                 random_number3 = total - random_number1 - random_number2
#                 rates.extend([random_number1, random_number2, random_number3])
#                 for i in range(3):
#                     actions.append([decides[i], rates[i]])
#                 next_state1, next_state2, reward, done, cost_time = env.step(actions)
#                 # print(reward)
#                 # replay_buffer.add(state1,state2 action, reward, next_state1,next_state2, done)  # 存储样本
#                 state1 = next_state1
#                 state2 = next_state2
...
#                 if done:
#                     break
#         ave_episode_return = episode_return / num_T / (vehicle_num_TV * num_lanes)
#         ave_time = sum_time / num_T / (vehicle_num_TV * num_lanes)
